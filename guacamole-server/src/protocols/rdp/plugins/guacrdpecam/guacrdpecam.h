...
/**
 * The device ID used for the default virtual camera advertised to Windows
 * before real browser capabilities are received.
 */
#define GUAC_RDPECAM_VIRTUAL_DEVICE_ID "default-camera"
